...
return [
    'customers' => [
        'forgot-password' => [
            'already-sent' => 'تم بالفعل إرسال رمز التحقق لهذا الرقم.',
            'back' => 'العودة إلى تسجيل الدخول؟',
            'bagisto' => 'باغيستو',
            'email' => 'رقم الهاتف',
            'email-not-exist' => 'لا يمكننا العثور على مستخدم بهذا رقم الهاتف',
            'footer' => '',
            'forgot-password-text' => 'إذا نسيت كلمة المرور، يمكنك استعادتها عن طريق إدخال رقم هاتفك المسجل.',
            'page-title' => 'هل نسيت كلمة المرور؟',
            'reset-link-sent' => 'تم إرسال رمز التحقق إلى هاتفك.',
