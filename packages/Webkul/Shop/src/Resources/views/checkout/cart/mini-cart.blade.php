...
<v-mini-cart>
    <span class="icon-cart cursor-pointer text-2xl text-gold hover:text-white" role="button"
        ...
        @if (core()->getConfigData('sales.checkout.mini_cart.display_mini_cart'))
            <x-shop::drawer>
                ...
                <x-slot:toggle>
                    ...
                    <span class="relative">
                        <span
                            class="icon-cart cursor-pointer text-2xl text-gold hover:text-white"
                            role="button"
                        ...
                        @if (core()->getConfigData('sales.checkout.my_cart.summary') == 'display_item_quantity')
                            <span
                                class="absolute -top-4 rounded-[44px] bg-gold px-2 py-1.5 text-xs font-semibold leading-[9px] text-brandBlack ltr:left-5 rtl:right-5 max-md:ltr:left-4 max-md:rtl:right-4"
                                v-if="cart?.items_qty"
                            >
                                @{{ cart.items_qty }}
                            </span>
                        @else
                            <span
                                class="absolute -top-4 rounded-[44px] bg-gold px-2 py-1.5 text-xs font-semibold leading-[9px] text-brandBlack ltr:left-5 rtl:right-5 max-md:px-2 max-md:py-1.5 max-md:ltr:left-4 max-md:rtl:right-4"
