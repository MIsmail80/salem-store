                            ...
                            <x-shop::form :action="route('shop.customers.reset_password.store')">
                                ...
                                <x-shop::form.control-group class="mb-6">
                                    ...
                                    <x-shop::form.control-group.control type="password"
                                        class="px-6 py-4 max-md:py-3 max-sm:py-1.5" name="password"
                                ...
                                <x-shop::form.control-group class="mb-6">
                                    ...
                                    <x-shop::form.control-group.control type="password"
                                        class="px-6 py-4 max-md:py-3 max-sm:py-1.5" name="password_confirmation"
                                ...
                                <!-- Submit Button -->
                                <div
                                    class="mt-8 flex flex-wrap items-center gap-9 max-sm:justify-center max-sm:text-center">
                                    <button
