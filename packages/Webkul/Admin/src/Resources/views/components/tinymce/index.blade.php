            ...
            methods: {
                init() {
                    ...
                    tinyMCEHelper.initTinyMCE({
                        ...
                        extended_valid_elements: 'svg[xmlns|width|height|viewbox|fill|stroke|class|style],path[d|fill|stroke|stroke-width|class|style],circle[cx|cy|r|fill|stroke|class|style],rect[x|y|width|height|fill|stroke|class|style],g[fill|stroke|class|style],polygon[points|fill|stroke|class|style],line[x1|y1|x2|y2|stroke|stroke-width|class|style],ellipse[cx|cy|rx|ry|fill|stroke|class|style],polyline[points|fill|stroke|class|style]',
                        valid_children: '+body[style|svg]',
